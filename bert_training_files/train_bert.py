...
from bert_training_files.bert_utils import email_processor as processors
...
def train(args: dict, train_dataset, model, tokenizer):
    """ Train the model """
    if args['local_rank'] in [-1, 0]:
        tb_writer = SummaryWriter(args['tensorboard_dir'])
        print("OPENING TENSORBOARD WRITER")
...
def evaluate(args: dict, model, tokenizer, prefix=""):
...
def load_and_cache_examples(args: dict, task, tokenizer, evaluate=False):
