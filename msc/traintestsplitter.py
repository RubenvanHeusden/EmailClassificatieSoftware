...
It contains several often used ways of splitting the dataset. If the dataset is already divided into
...
class TrainTestSplitter:
    ...
    def stratify_file(file_name: str, delimiter: str = ",", quotechar: str = '"', text_col_name: str = "text",
        ...
        dataframe = pd.read_csv(file_name, sep=delimiter, quotechar=quotechar)
    ...
    def reshuffle(self, train_file_path: str, test_file_path: str, delimiter: str = ",", quotechar: str = '"',
        ...
        :param train_portion: integer indicating the percentage of the total dataset that is used for training \
        the test set size is set to (1-train_portoin), default is 0.7.
        :return: returns a tuple of two dataframes wher the first is the train dataframe and the second \
        is the test dataframe
