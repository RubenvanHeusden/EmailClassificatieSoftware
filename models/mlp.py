"""
This file contains the implementation of a simple multi-layer feedforward neural that is internally
used by the Multigate model.
"""
...
class MLP(nn.Module):
    ...
    def __init__(self, input_dim: int, layer_sizes: List[int], output_dim: int):
        ...
        :param layer_sizes:a list of integers specifying the size of each hidden layer, \
        the number of hidden layers is inferred from the length of the list.
